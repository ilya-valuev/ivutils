 ...
 *
 *   $Revision: 1.14 $
 *   $Date: 2009/07/24 05:08:46 $
 *   @(#) $Header: /home/plasmacvs/source_tree/ivutils/include/pencil.h,v 1.14 2009/07/24 05:08:46 valuev Exp $
 *
 *****************************************************************************/
/*
$Source: /home/plasmacvs/source_tree/ivutils/include/pencil.h,v $
$Revision: 1.14 $
$Author: valuev $
$Date: 2009/07/24 05:08:46 $
*/
...
/// making container of a pointer (to look like a vector)
template <class T>
class ptr_container {
  T* ptr;
  int master;
...
//e this class is used to convert argument of pencil constructor
//e which can be either T* or container_t &
...
//e the array can be managed and copied by reference (ref counting used)
//e compatible with vector<T> used as container
...
public:
  ...
  //e mode=0:  if this size is too small, creates new reference data!
  //e          in which case other referring pencils will not be updated
  //e mode=1:  if this size is too small, copies the first portion of the data only
  //e          
  ...
  //e same as begin(), reatined for compatibility
