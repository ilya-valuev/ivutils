 ...
 *   @(#) $Header: /home/plasmacvs/source_tree/ivutils/include/pairhash.h,v 1.34 2014/07/18 14:04:37 morozov Exp $
 *
 *****************************************************************************/
/*
$Source: /home/plasmacvs/source_tree/ivutils/include/pairhash.h,v $
$Revision: 1.34 $
$Author: morozov $
$Date: 2014/07/18 14:04:37 $
*/
/*e****************************************************************************
 * $Log: pairhash.h,v $
 * Revision 1.34  2014/07/18 14:04:37  morozov
 * Made compilable by icc 11.1
 *
 * Revision 1.33  2014/07/17 11:57:32  valuev
 * more correct oscillator partition
 *
 * Revision 1.32  2014/04/17 13:51:00  kazeev
 * Fixed gcc compilation. Added BoxHamiltonian.
 *
 * Revision 1.31  2012/09/28 11:25:40  valuev
 * updated degeneracy constraints
 *
 * Revision 1.30  2012/06/29 10:50:12  valuev
 * added linear constraints
 *
 * Revision 1.29  2011/06/22 08:31:38  valuev
 * derivative fixes
 *
...
public:
  ...
  recmatrix(T *ptr): parr(ptr,0) {
    sizey=sizex=0;
    // Might be wrong. Kazeevn
    arr=NULL;
  }
  ...
  // i is row number (x), j is column number (y)
...
public:
  ...
  //e initializes by unmanaged pointer
  // https://stackoverflow.com/questions/3319892/c-why-does-my-derivedclasss-constructor-not-have-access-to-the-baseclasss-p
sqmatrix(size_t n, T *ptr): recmatrix<T>(ptr), size(n) {
    init(n);
  }
